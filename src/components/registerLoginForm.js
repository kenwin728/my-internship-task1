    ...
    return(
        <section className="bg-gray-50 dark:bg-gray-900">
            <div className="flex flex-col items-center justify-center px-6 py-8 min-h-screen mx-auto">
                ...
                {showRegister ? (
                    <>
                        <RegistrationForm changeToLoginForm={ changeForm }/>
                        <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <button className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={changeForm}>Login here</button>
                        </p>
                    </>
                ) : (
                    <>
                        <LoginForm />
                        <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don't have an account yet? <button className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={changeForm}>Register here</button>
                        </p>
                    </>
                )}
